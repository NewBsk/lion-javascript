...
const spreadObject = { ...messenger }; // 개꿀 얘만 알아도 평타는 친다

// 4. 객체를 복사해주는 유틸 함수

const copydObject = (object) => Object.assign({}, object);
// copydObject라는 함수는 object를 매개변수로 받고 object의 assign을 통해서 전달받은 object를 복사해서 값을 반환하는 함수다.
